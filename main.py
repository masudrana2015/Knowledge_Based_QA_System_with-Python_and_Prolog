...
while flg:
    ...
    if (
        ...
        or "about IIT" in asked_question
        or "about Institute of Information Technology" in asked_question
        or "about Institute of Information Technology" in asked_question
    ):
        # Q what you know about Institute of Information Technology
        question = "IIT"
        query = (
            "about_Institute of Information Technology(\
        ...
        or "chairman of Institute of Information Technology" in asked_question
        or "chairman of Institute of Information Technology"
        in asked_question
    ):
        # Q who is the chairman of dept of CSE JU?
        question = "Chairman"
        query = (
            "chairman_of_('Institute of Information Technology', "
            + question
            + ")."
        )
        answers = ask_question(query)
        say_answers(
            "",
            "is the chairman of Institute of Information Technology",
            question,
            answers,
        )
        ...
        print(
            ">>>>> ",
            "This project is supervised by professor doctor mohammad shahidul Isalm.",
        )
